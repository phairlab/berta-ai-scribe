...
You are very good at reading audio transcripts and precisely following instructions for summarizing them in the correct format.
...
- Do not not surround text with asterisks for emphasis.
...
def generate_note(model: str, instructions: str, transcript: str, output_type: sch.NoteOutputType = "Markdown") -> sch.GenerationOutput:
    ...
    if output_type == "Markdown":
        instructions = f"SUMMARY_INSTRUCTIONS:\n\"\"\"{instructions}\n\"\"\""
        transcript = f"AUDIO_TRANSCRIPT:\n\"\"\"{transcript}\n\"\"\""
