...
export function useNoteGenerator({
  ...
  const generateNote = async (
    ...
    try {
      ...
      if (includeFooter) {
        const noteFooter = `<<This note, in part generated by the AHS Jenkins Scribe, is approved for the medical record. Note ID: ${encounterId}-${draftNote.id}. The patient verbally consented to using this tool.>>`;
