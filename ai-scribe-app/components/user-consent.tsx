...
export const UserConsent = () => {
  ...
  useEffect(() => {
    let consentAgreed: string | null = sessionStorage.getItem("consentAgreed");

    if (!consentAgreed || consentAgreed !== "Yes") {
      onOpen();
    }
  }, []);

  const handleAgreed = () => {
    sessionStorage.setItem("consentAgreed", "Yes");
    onClose();
  };
          ...
          <div className="flex flex-col gap-6 justify-center items-center">
            <div className="flex flex-col gap-3 text-small text-zinc-500 max-w-[90%] sm:max-w-[600px]">
              ...
              <p>
                ...
                Alberta&apos;s Health Care System. I would like your permission
                to record and transcribe your visit. I will use this to help
                summarize the outcomes of your visit on your chart. Saying no to
                being recorded is okay and will have no impact on your
                care.&quot;
              </p>
            </div>
          </div>
